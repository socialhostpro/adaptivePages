                  ...
                  <div className="relative">
                    ...
                    {businessData.website && (
                      <button
                        ...
                        className="absolute right-3 top-1/2 transform -translate-y-1/2 p-2 text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 disabled:opacity-50"
