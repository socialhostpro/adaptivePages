...
import type { FeaturesSectionData, LandingPageTheme } from '../../types';
      ...
      <div className="max-w-7xl mx-auto text-center">
        ...
        <div className="mt-16 grid gap-10 sm:grid-cols-2 lg:grid-cols-3">
          {(section.items || []).map((feature, index) => (
            <div key={index} className="bg-white dark:bg-gray-900 p-8 rounded-xl shadow-lg transform hover:-translate-y-2 transition-transform duration-300">
              ...
              <h3 className={`text-xl font-bold text-${theme.textColorName}-900 dark:text-${theme.textColorName}-100`}>{feature.name}</h3>
