...
import type { ManagedOrder, OrderStatus, ManagedPage, ManagedProduct, ProductCategory, MediaFile, CrmContact, Task } from './types';
...
const ShopManagement: React.FC<ShopManagementProps> = (props) => {
    ...
    const renderContent = () => {
        switch(activeTab) {
            ...
            case 'orders': return <OrdersTable pages={pages} orders={orders} onUpdateStatus={handleUpdateOrderStatus} highlightedOrderId={highlightedOrderId} onHighlightComplete={() => setHighlightedOrderId(null)} showPageName={true} allTasks={allTasks} onOpenTaskModal={onOpenTaskModal} onUpdate={onUpdate} />;
