/**
 * @file Auth.tsx
 * @description This component handles the user authentication flow, providing UI for both login and signup.
 * It features a dynamic background that cycles through a set of predefined images.
 */
...
/**
 * An array of background image URLs for the authentication screen.
 * @type {string[]}
 */
...
/**
 * Renders the authentication page for user login and signup.
...
export default function Auth(): React.ReactElement {
  ...
  /**
   * Handles the submission of the login or signup form.
  ...
  const handleAuth = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    console.log(`[AUTH] Starting ${authMode} for email:`, email);
    ...
    if (authMode === 'login') {
      ...
      if (error) {
        ...
        console.log('[AUTH] User exists but not confirmed');
