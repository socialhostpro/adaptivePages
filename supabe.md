NEXT_PUBLIC_SUPABASE_URL=https://api.imaginecapital.ai
NEXT_PUBLIC_SUPABASE_ANON_KEY=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InJ4a3l3Y3lscnRvaXJzaGZxcXBkIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTI1MjQ5ODYsImV4cCI6MjA2ODEwMDk4Nn0.M79J1j4-bpKpqlCLmHylOX64vbudaBwrBD6-e1fQ18M

---

## CRITICAL: Supabase Database & Storage Setup SQL
...
**Note:** This is the complete, consolidated script. For organizational purposes, the schema has also been broken down into individual `sql_*.md` files for each feature set (e.g., `sql_store.md`, `sql_bookings.md`).
